package com.techproed.apiToDeploy.jwt;
...
public class JwtTokenVerifier extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		try {
			...
			String username = body.getSubject();//This code will return username "PAYLOAD:DATA" part
			
			var authorities = (List<Map<String, String>>) body.get("authorities");
			
			Set<SimpleGrantedAuthority> simpleGrantedAuthorities = authorities.
													stream().
													map(t->new SimpleGrantedAuthority(t.get("authority"))).
