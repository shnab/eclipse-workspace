...
public class String01 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(s4.endsWith(""));//true==>after k there is nothing
		...
		System.out.println("".isEmpty());//true ==> there is no character in it
		
	   //9.lastIndexOf()
	   System.out.println(s6.lastIndexOf("n"));//20
	   System.out.println(s6.lastIndexOf('y'));//17 ==> char is possible
	   System.out.println(s6.lastIndexOf(""));//22 ==> -1 yaparsak galiba bosluk dahil toplam karakter sayisini buluruz.
	   System.out.println(s6.lastIndexOf("ing"));//19
	   System.out.println(s6.lastIndexOf("xxx"));//-1
	   System.out.println(s6.lastIndexOf('n', 15));//10 ==> Sondan basa geriye dogru sayiyoruz. 
	   ...
	   System.out.println(s7.replace(" ", "").lastIndexOf("")); //17 ==>
